...
class GalleryView
{
    ...
    static public function galleryForm($data = array())
    {
        $html = "";
        ...
        $html .= self::generateOption(Gallery::$_schema_states, $data['schema']);
        $html .= "    </select><br />\n";
        $html .= "    <label for=\"guide\">Instrukcja użytkownika</label>\n";
        $html .= "    <select id=\"guide\" name=\"form_data[guide]\" onchange=\"this.form.submit()\">\n";
        $html .= self::generateOption(Gallery::$_schema_states, $data['guide']);
        $html .= "    </select><br />\n";
        $html .= "  </fieldset>\n";
        ...
        if($data['guide']==2) $html .= self::galleryDescription($data);
    ...
    static public function galleryResult($content)
    {
        $html = "";
    ...
    static public function galleryDescription($data = array())
    {
        $html = "";
        $html .= "<fieldset>";
    ...
    static public function generateOption($data = array(), $selected)
    {
        $html = "";
    ...
    public static function generateHTMLGalleryItem($data = false)
    {
        $html = "";
